...
echo "  5. Start monitor: docker compose -f docker-compose.monitoring.yml up -d"
echo ""
echo "  Check status:     docker compose ps && docker compose -f docker-compose.monitoring.yml ps"
echo ""
